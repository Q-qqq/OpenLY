...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalSpacer = QSpacerItem(134, 67, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_7.addItem(self.horizontalSpacer, 0, 3, 1, 1)

        self.horizontalSpacer_2 = QSpacerItem(135, 55, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalSpacer_3 = QSpacerItem(278, 55, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_7.addItem(self.horizontalSpacer_3, 2, 3, 1, 2)

        self.horizontalSpacer_5 = QSpacerItem(135, 23, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalSpacer_4 = QSpacerItem(135, 23, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
