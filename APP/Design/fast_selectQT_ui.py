...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Finish_pb = QPushButton(self.widget_5)
        ...
        self.horizontalLayout_4.addWidget(self.Finish_pb)

        self.Cancel_pb = QPushButton(self.widget_5)
        ...
        self.gridLayout_5.addWidget(self.widget_5, 0, 5, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.widget_2, 0, 4, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.stackedWidget, 1, 0, 1, 6)

        self.FF_color_ch_cbb = QComboBox(Form)
        ...
        self.gridLayout_5.addWidget(self.FF_color_ch_cbb, 0, 2, 1, 1)

        self.Fast_sel_methods_cbb = QComboBox(Form)
        ...
        self.Fast_sel_methods_cbb.setFont(font3)

        self.gridLayout_5.addWidget(self.Fast_sel_methods_cbb, 0, 0, 1, 1)
