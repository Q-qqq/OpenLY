...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalSpacer = QSpacerItem(321, 95, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_7.addItem(self.horizontalSpacer, 0, 2, 1, 1)

        self.horizontalSpacer_2 = QSpacerItem(322, 96, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalSpacer_6 = QSpacerItem(321, 95, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_7.addItem(self.horizontalSpacer_6, 2, 2, 1, 1)

        self.horizontalSpacer_5 = QSpacerItem(322, 23, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalSpacer_4 = QSpacerItem(321, 23, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
