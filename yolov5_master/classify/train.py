...
from yolov5_master.classify import val as validate
from yolov5_master.models.experimental import attempt_load
from yolov5_master.models.yolo import ClassificationModel, DetectionModel
from yolov5_master.utils.dataloaders import create_classification_dataloader
...
from yolov5_master.utils.plots import imshow_cls
    ...
    for epoch in range(epochs):  # loop over the dataset multiple times
        ...
        for i, (images, labels) in enumerate(trainloader):  # progress bar
            ...
            if RANK in {-1, 0}:
                ...
                desc = f"{f'{epoch + 1}/{epochs}':>10}{mem:>10}{tloss:>12.3g}" + " " * 36

                # Test
                if i == epochs - 1:  # last batch
