...
from yolov5_master.utils.general import colorstr, cv2
from yolov5_master.utils.loggers.clearml.clearml_utils import ClearmlLogger
from yolov5_master.utils.loggers.wandb.wandb_utils import WandbLogger
from yolov5_master.utils.plots import plot_images, plot_labels, plot_results
...
try:
    if RANK in {0, -1}:
        ...
        from yolov5_master.utils.loggers.comet import CometLogger
