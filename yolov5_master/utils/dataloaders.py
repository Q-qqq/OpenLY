...
from yolov5_master.utils.augmentations import (
    Albumentations,
    augment_hsv,
...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(
        ...
        if cache_images:
            ...
            for i, x in results:
                ...
                desc = f"{prefix}Caching images ({b / gb:.1f}GB {cache_images})"
    ...
    def cache_labels(self, path=Path("./labels.cache"), prefix=""):
        ...
        with Pool(NUM_THREADS) as pool:
            ...
            for im_file, lb, shape, segments, nm_f, nf_f, ne_f, nc_f, msg in results:
                nm += nm_f
                nf += nf_f
                ne += ne_f
                nc += nc_f
                ...
                if msg:
                    msgs.append(msg)
                desc = f"{desc} {nf} images, {nm + ne} backgrounds, {nc} corrupt"
