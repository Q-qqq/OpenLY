...
import yolov5_master.segment.val as validate  # for end-of-epoch mAP
from yolov5_master.models.experimental import attempt_load
from yolov5_master.models.yolo import SegmentationModel
from yolov5_master.utils.autoanchor import check_anchors
from yolov5_master.utils.autobatch import check_train_batch_size
from yolov5_master.utils.callbacks import Callbacks
from yolov5_master.utils.downloads import attempt_download, is_url
from yolov5_master.utils.general import (
    TQDM_BAR_FORMAT,
    check_amp,
    check_dataset,
    check_file,
...
from yolov5_master.utils.loggers import GenericLogger
from yolov5_master.utils.plots import plot_evolve, plot_labels
from yolov5_master.utils.segment.dataloaders import create_dataloader
from yolov5_master.utils.segment.loss import ComputeLoss
from yolov5_master.utils.segment.metrics import KEYS, fitness
from yolov5_master.utils.segment.plots import plot_images_and_masks, plot_results_with_masks
from yolov5_master.utils.torch_utils import (
    EarlyStopping,
    ModelEMA,
    de_parallel,
    select_device,
...
def train(hyp, opt, device, callbacks):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        optimizer.zero_grad()
        for i, (imgs, targets, paths, _, masks) in enumerate(train_loader):  # batch ------------------------------------------------------
