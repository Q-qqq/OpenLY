...
from yolov5_master.utils.dataloaders import exif_transpose, letterbox
...
from yolov5_master.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        if pt:  # PyTorch
            ...
            from yolov5_master.utils.triton import TritonRemoteModel
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from yolov5_master.export import export_formats
        from yolov5_master.utils.downloads import is_url
