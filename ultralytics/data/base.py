...
from ultralytics.data.utils import FORMATS_HELP_MSG, HELP_URL, IMG_FORMATS, cv2_readimg
from ultralytics.utils import DEFAULT_CFG, LOCAL_RANK, LOGGER, NUM_THREADS, TQDM, PROGRESS_BAR
...
class BaseDataset(Dataset):
    ...
    def check_cache_ram(self, safety_margin=0.5):
        ...
        n = min(self.ni, 30)  # extrapolate from 30 random images
        for _ in range(n):
            im = cv2_readimg(random.choice(self.im_files))  # sample image
            if im is None:
                continue
